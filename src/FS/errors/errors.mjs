...
export const errorNotDirInFile = 'Неможливо створити директорію за цим посиланням'
export const errorWrongDescriptionNumber = 'Неправильна кількість дескрипторів'
export const errorToNumberDes = 'Немає вільних дескрипторів'
...
export const errorSymbol = 'Неприпустимі символи'
export const errorItsDirectory = "Посилання вказує на директорію"
export const errorТoDiskSpace = 'Недостатньо місця на диску'